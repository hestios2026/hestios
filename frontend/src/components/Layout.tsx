...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  reclamatii:    <><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></>,
...
const icons: Record<string, () => JSX.Element> = {
  ...
  reclamatii:    () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>,
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'reclamatii',   roles: ['director','projekt_leiter','polier','sef_santier','callcenter'] },
